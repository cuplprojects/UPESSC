          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
            ...
            <div className="flex items-center gap-3 sm:gap-4 flex-1 order-1 sm:order-none">
              ...
              <div className="text-center sm:text-left">
                <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold" data-testid="text-college-name">
                  {t('header.collegeName')}
                </h1>
                <p className="text-xs sm:text-sm opacity-90 mt-1" data-testid="text-subtitle">
                  {t('header.subtitle')}
                </p>
              </div>
            </div>
            ...
            {/* Language Toggle */}
            <div className="flex bg-[#050C9C]/80 rounded-lg p-1 order-2 sm:order-none" data-testid="language-toggle">
              <Button
                variant="ghost"
                size="sm"
